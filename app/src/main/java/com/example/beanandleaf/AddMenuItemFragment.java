...
public class AddMenuItemFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final TextView caloriesEdit = view.findViewById(R.id.calories_edit);
        ...
        addItemButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.contentEquals("") || calories.contentEquals(""))
                    return;

                if (!isValidInteger(calories)) {
                    Toast.makeText(getActivity().getApplicationContext(), "Please enter calories as a valid integer", Toast.LENGTH_LONG).show();
                    return;
                }

                if (cafSmall.contentEquals("") && !priceSmall.contentEquals("")) {
                ...
                if (cafMedium.contentEquals("") && !priceMedium.contentEquals("")) {
                ...
                if (cafLarge.contentEquals("") && !priceLarge.contentEquals("")) {
